...
$.extend($.easing, {
    ...
    (function (t) {
        ...
        (Wolmart.getCookie = function (t) {
            for (
                var e = t + "=", i = document.cookie.split(";"), a = 0; a < i.length;
                ++a
            ) {
                for (var n = i[a];
        ...
        var e = function (t) {
            ...
            a = {
                ...
                initMobileMenu: function () {
                    ...
                    // When search input is focused, add a class to the mobile menu wrapper
                    t(".mobile-menu-container input[name='search']").on("focus", function () {
                        mobileMenu.addClass("keep-open");
                    });

                    // Remove the class when the input loses focus
                    t(".mobile-menu-container input[name='search']").on("blur", function () {
                        mobileMenu.removeClass("keep-open");
                    });

                    // Modify the close behavior to only close if the menu does not have the keep-open class
