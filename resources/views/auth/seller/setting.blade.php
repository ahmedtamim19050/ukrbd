                                    ...
                                    <form class="  " action="{{ route('vendor.shopMenuStore.store') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row ">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="meta[menuTitle1]" value="{{ auth()->user()->shop->menuTitle1 ?? null }}" class="form-control @error('meta') is-invalid @enderror" id="menuTitle1">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="meta[menuLink1]" value="{{ auth()->user()->shop->menuLink1 ?? null }}" class="form-control @error('meta') is-invalid @enderror" id="menuLink1">
                                            ...
                                            <div class="col-md-6 mt-2">
                                                ...
                                                <input type="text" name="meta[menuTitle2]" value="{{ auth()->user()->shop->menuTitle2 ?? null }}" class="form-control @error('meta') is-invalid @enderror" id="menuTitle2">
                                            ...
                                            <div class="col-md-6 mt-2">
                                                ...
                                                <input type="text" name="meta[menuLink2]" value="{{ auth()->user()->shop->menuLink2 ?? null }}" class="form-control @error('meta') is-invalid @enderror" id="menuLink2">
