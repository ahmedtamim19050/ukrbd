    ...
    <section class="ec-page-content section-space-p">
        <div class="container">
            <div class="row">
                ...
                <div class="ec-login-wrapper mb-5" style="max-width: 730px; margin:0 auto;box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px; padding:20px">
