                ...
                <div class="list-group lg-alt mt-3" style="height: 70vh;overflow-x: auto;">
                    ...
                    @if ($user->isNotEmpty)
                        <a class="list-group-item media" href="" style="background-color: #EEEEEE;">
                            <div class="pull-left">
                                <img src="{{ $user->logo ? Storage::url($user->logo) : 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/59/User-avatar.svg/2048px-User-avatar.svg.png' }}"
                    ...
                    @foreach ($shops as $u)
                        <a class="list-group-item media" href="{{ route('massage.create', $u->id) }}">
                            <div class="pull-left">
                                <img src="{{ $u->logo ? Storage::url($u->logo) : 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/59/User-avatar.svg/2048px-User-avatar.svg.png' }}"
                                    alt="" class="img-avatar">
                            </div>
                            <div class="media-body">
                    ...
                    @if ($user->id)
                        <form action="{{ route('massage.store', $user->id) }}">
                            <div class="msb-reply" style="position: absolute;width: 100%;bottom:0">
                                <input type="test" style="border:none" placeholder="What's on your mind..."
                                    name="massage">
